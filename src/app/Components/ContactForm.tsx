...
const ContactForm = () => {
  ...
  return (
    <motion.div
      ...
      className="relative max-w-4xl mx-auto bg-gradient-to-br from-white/90 to-gray-50/90 dark:from-gray-900/95 dark:to-gray-800/95 p-8 md:p-10 rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-lg overflow-hidden"
    ...
    >
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={label}
                    className={`pl-12 w-full px-5 py-3.5 rounded-xl border ${errors[field] ? "border-red-500" : "border-gray-300 dark:border-gray-700"} bg-white/80 dark:bg-gray-800/80 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 backdrop-blur transition-all duration-300`}
          ...
          <div className="relative group">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={5}
                className={`pl-12 w-full px-5 py-3.5 rounded-xl border ${errors.message ? "border-red-500" : "border-gray-300 dark:border-gray-700"} bg-white/80 dark:bg-gray-800/80 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 backdrop-blur transition-all duration-300`}
                disabled={isSubmitting}
              />
            </div>
          </div>
      ...
      >
        ...
        <a href="mailto:chandan42kumar55@gmail.com" className="text-indigo-500 hover:text-pink-500 transition-colors">
