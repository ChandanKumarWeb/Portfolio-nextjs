  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-7xl mx-auto gap-10">
        ...
        <motion.div
          className="order-2 md:order-1 w-full md:w-1/2 px-4"
          ref={ref}
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg leading-relaxed mb-6">
            ...
            I build responsive UIs using Angular Material, Bootstrap, and Tailwind CSS.
            Skilled in API integration, dynamic data handling, permission-based UI, and report generation.
            Passionate about clean design and intuitive UX.
          </p>
